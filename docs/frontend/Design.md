...
- **Toasts:** stack from the **top right**, newest last, with the semantic tint of their tone and a live region so they are announced. Nothing else uses that corner.

...
import { AcademicProgressCard } from '@/components/dashboard/parent/AcademicProgressCard'
import { FeeHistoryCard } from '@/components/dashboard/parent/FeeHistoryCard'
import { ParentNoticesCard } from '@/components/dashboard/parent/ParentNoticesCard'
import { PendingHomeworkCard } from '@/components/dashboard/parent/PendingHomeworkCard'
import { RecentResultsCard } from '@/components/dashboard/parent/RecentResultsCard'

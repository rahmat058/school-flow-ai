...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-transparent text-ink border border-line hover:bg-primary-soft hover:text-primary',
  ghost: 'bg-transparent text-ink-muted hover:text-primary hover:bg-primary-soft',
